...
class ProfileLocalDataSourceImpl implements ProfileLocalDataSource {
  ...
  @override
  Future<List<HelpScreenResponseDto>> getHelpScreenContent() async {
    ...
    return jsonList.map((e) => HelpScreenResponseDto.fromJson(e)).toList();
  }

  @override
  Future<List<PrivacyPolicyResponseDto>>
